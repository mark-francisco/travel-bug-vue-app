<template>
  <div id="app">
    <!-- ECOLAND NAVBAR -->
    <nav
      class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-light ftco-navbar-light site-navbar-target"
      id="ftco-navbar"
    >
      <div class="container">
        <router-link to="/">
          <a class="navbar-brand" id="travel-bug-brand">Travel Bug</a>
        </router-link>
        <button
